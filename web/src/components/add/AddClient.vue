        ...
        <div class="row justify-content-center">
            ...
            <div v-else class="col-md-6 mt-4 py-4 px-3 rounded shadow">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12 form-floating">
                        <input v-model="email" type="mail" class="form-control" id="floatingInput8" >
                        <label for="floatingInput8">Mail</label>
                    </div>
                    <div class="col-6 form-floating">
...
export default {
    ...
    methods:{
      ...mapActions(["postActions","putActions","deleteActions","getActions"]),
        back(){
        ...
        addClient(){
            ...
            this.error=""
            if(this.updating){
              this.putActions({path:`/api/clients/${this.$route.params.id}`,data:client})
              .then(()=>{
                  this.loading=false
              ...
              this.postActions({path:'/api/clients',data:client})
              .then(()=>{
                this.loading=false
        ...
        deleteClient(){
            Swal.fire({
                ...
                if (result.isConfirmed) {
                  this.deleteActions({path:`/api/clients/${this.$route.params.id}`})
                  .then(()=>{
        ...
        getClient(){
          ...
          this.getActions({path:`/api/clients/${id}`})
          .then(({data})=>{
            this.nom=data.nom
